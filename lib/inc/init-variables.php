...
if ( ! function_exists( 'ghostpool_init_variables' ) ) {
	function ghostpool_init_variables() {
		...
		--------------------------------------------------------------*/
			...
			$GLOBALS['ghostpool_custom_title'] = redux_post_meta( 'socialize', $gp_page_id, 'page_custom_title' ) ? redux_post_meta( 'socialize', $gp_page_id, 'page_custom_title' ) : '';
			
			$GLOBALS['ghostpool_subtitle'] = redux_post_meta( 'socialize', $gp_page_id, 'page_subtitle' );
