	...
	<?php if ( has_post_thumbnail() ) { ?>
		...
		<div class="gp-post-thumbnail gp-loop-featured">
			...
			<?php if ( $GLOBALS['ghostpool_format'] != 'gp-portfolio-masonry' ) {
				...
				$gp_image = aq_resize( wp_get_attachment_url( get_post_thumbnail_id( get_the_ID() ) ), apply_filters( 'gp_portfolio_narrow_image_width', '1000' ), apply_filters( 'gp_portfolio_narrow_image_height', '500' ), true, false, true );
